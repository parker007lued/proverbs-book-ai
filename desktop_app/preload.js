...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  // Bible Summary (Orthodox-aligned)
  bibleSummary: (data) => ipcRenderer.invoke('bible-summary', data),
  bibleQuestion: (question) => ipcRenderer.invoke('bible-question', question),
